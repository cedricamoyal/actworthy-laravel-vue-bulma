...
// load all components
Vue.component('guest-list', __webpack_require__(33));
...
Component.options.__file = "resources/assets/js/components/Guest-list.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8abc312c", Component.options)
  } else {
    hotAPI.reload("data-v-8abc312c", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetchGuestList: function fetchGuestList() {
            var _this = this;

            axios.get('current_guests').then(function (result) {
        ...
        createGuest: function createGuest() {
            ...
            axios.post('create_guest', this.guest).then(function (result) {
                _this2.guest.guestEmail = '';
                _this2.guest.guestPassword = '';
                _this2.fetchGuestList();
            }).catch(function (err) {
                console.log(err);
            });
        },
        ...
        deleteGuest: function deleteGuest(id) {
            ...
            axios.post('delete_guest/' + id).then(function (result) {
                _this3.fetchGuestList();
            }).catch(function (err) {
                console.log(err);
            });
        }
              ...
              _c("input", {
                ...
                on: {
                  input: function($event) {
                    ...
                    _vm.$set(_vm.guest, "guestEmail", $event.target.value)
                  }
                }
              })
            ]),
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.guest.guestPassword,
                    expression: "guest.guestPassword"
                  }
                ],
                staticClass: "input",
                attrs: { type: "text", placeholder: "Password" },
                domProps: { value: _vm.guest.guestPassword },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.guest, "guestPassword", $event.target.value)
                  }
                }
              })
            ]),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-8abc312c", module.exports)
  }
}
